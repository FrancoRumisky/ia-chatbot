...
class SessionService:
    ...
    def get_or_create_history(self, session_id: str) -> List[Dict[str, str]]:
        data = self._store.get_or_create_history(session_id)
    ...
    def set_document_ids(self, session_id: str, document_ids: List[str]) -> None:
        self._store.set_document_ids(session_id, document_ids)

    def get_document_ids(self, session_id: str) -> List[str]:
        data = self._store.get_or_create_history(session_id)
    ...
    def get_full_session_data(self, session_id: str) -> Dict[str, Any]:
        return self._store.get_or_create_history(session_id)
